...
the scripts expect filenames in the form "lang-code~treebank-name_UD~version.conllu" (the tilde sign separates parts of the filename). For example, in the case of the 2.15 version of the Slovenian SSJ treebank this will be "sl~Slovenian-SSJ~2.18.conllu".
