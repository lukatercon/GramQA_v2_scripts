...
"""
ID: L10
Inventory question: Which interjections are attested?
UD-oriented version: Which distinct LEMMA values are attested on tokens with UPOS=INTJ?
Output - a frequency list of: Interjection lemmas
"""

input_path = sys.argv[1]
output_path = sys.argv[2]

data_cont = DataContainer("L10", input_path)
...
data_cont.export_json(output_path, "no_tokens_with_UPOS=INTJ")
