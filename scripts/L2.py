...
"""
ID: L2
Inventory question: Which words function as auxiliaries?
UD-oriented version: Which distinct LEMMA values are attested on tokens whose DEPREL is aux?
Output - a frequency list of: Auxiliary lemmas (or word forms)
"""

input_path = sys.argv[1]
output_path = sys.argv[2]

data_cont = DataContainer("L2", input_path)
